...
DESKTOP_RESOURCES_RE = re.compile(
    r'            <li><a href="how-we-work">How we work</a></li>\s*\n'
    r'            <li><a href="blog">Blog</a></li>\s*\n'
...
MOBILE_OLD = """    <a href="how-we-work" onclick="closeMobile()">How we work</a>
...
def patch_text(name: str, text: str) -> str:
    if "navResourcesMenu" in text and 'href="pricing"' in text and "initNavServicesAria" in text:
        # Heuristic skip if already fully patched (re-run safe for aria only)
        pass

    text = text.replace("index.html#packages", "pricing")
    text = text.replace('<li><a href="#packages">Pricing</a></li>', '<li><a href="pricing">Pricing</a></li>')
    text = text.replace(
        '<a href="#packages" onclick="closeMobile()">Pricing</a>',
        '<a href="pricing" onclick="closeMobile()">Pricing</a>',
    )
    text = text.replace('<li><a href="#packages">Pricing</a></li>', '<li><a href="pricing">Pricing</a></li>')
    text = text.replace('href="#packages"', 'href="pricing"')
